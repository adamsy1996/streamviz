...
export const artifactExamples: ArtifactExample[] = [
  { id: 'sequence', title: 'Agent conversation system', titleZh: 'Agent 对话系统', description: 'A generated sequence diagram of the complete agent, tool, and streaming visualization lifecycle.', descriptionZh: '由模型生成的 Agent、工具与流式可视化完整时序图。', code: sequenceDiagramCode },
